...
{
	m_editAccount.SetRectangleColor(theApp.GetHotColor2(),theApp.GetNormalColor());
	...
	m_editZipCode.SetRectangleColor(theApp.GetHotColor2(),theApp.GetNormalColor());
...
void CDlgEditAccInfo::Save(void)
{
	...
	if (sUserName.IsEmpty())
	{
		...
		CDlgMessageBox::EbMessageBox(this,_T("请输入名称！"),_T(""),CDlgMessageBox::IMAGE_ERROR);
		return;
	}

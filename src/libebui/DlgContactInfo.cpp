...
BOOL CDlgContactInfo::OnInitDialog()
{
	...
	m_editContact.SetRectangleColor(theApp.GetHotColor2(),theApp.GetNormalColor());
	m_editName.SetRectangleColor(theApp.GetHotColor2(),theApp.GetNormalColor());
	m_editPhone.SetRectangleColor(theApp.GetHotColor2(),theApp.GetNormalColor());
	m_editCompany.SetRectangleColor(theApp.GetHotColor2(),theApp.GetNormalColor());
	...
	m_editTel.SetRectangleColor(theApp.GetHotColor2(),theApp.GetNormalColor());
...
void CDlgContactInfo::OnBnClickedOk()
{
	...
	{
		m_editName.SetFocus();
		CDlgMessageBox::EbDoModal(this,_T("请输入姓名！"),_T(""),CDlgMessageBox::IMAGE_WARNING);
		return;
	}

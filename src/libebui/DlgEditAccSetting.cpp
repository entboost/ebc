...
{
	m_bEnableOutEntCall.SetCheckBoxHoverBorder(TRUE,theApp.GetHotColor2());
	m_bEnableOutEntAccept.SetCheckBoxHoverBorder(TRUE,theApp.GetHotColor2());
	m_bEnableUserCall.SetCheckBoxHoverBorder(TRUE,theApp.GetHotColor2());
	m_bEnableUserAccept.SetCheckBoxHoverBorder(TRUE,theApp.GetHotColor2());
	m_bEnableVisitorCall.SetCheckBoxHoverBorder(TRUE,theApp.GetHotColor2());
	m_bEnableVisitorAccept.SetCheckBoxHoverBorder(TRUE,theApp.GetHotColor2());
	m_bEnableOffCall.SetCheckBoxHoverBorder(TRUE,theApp.GetHotColor2());
	m_bEnableOffFile.SetCheckBoxHoverBorder(TRUE,theApp.GetHotColor2());
	m_bEnableContactAccept.SetCheckBoxHoverBorder(TRUE,theApp.GetHotColor2());
}

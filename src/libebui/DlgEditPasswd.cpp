...
{
	m_editOldPwd.SetRectangleColor(theApp.GetHotColor2(),theApp.GetNormalColor());
	m_editNewPwd.SetRectangleColor(theApp.GetHotColor2(),theApp.GetNormalColor());
	m_editConfirm.SetRectangleColor(theApp.GetHotColor2(),theApp.GetNormalColor());
}

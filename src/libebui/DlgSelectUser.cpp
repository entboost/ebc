...
BOOL CDlgSelectUser::OnInitDialog()
{
	...
	m_editSearch.SetRectangleColor(theApp.GetHotColor2(),theApp.GetNormalColor());
	...
	m_treeDepartment.SetRectangle(RGB(144,174,205));
	//m_treeDepartment.SetItemIcon( theApp.GetIconCon() );
	m_treeDepartment.SetCallback((CTreeCallback*)this);
	m_treeDepartment.ShowWindow(SW_SHOW);
	//m_icon = AfxGetApp()->LoadIcon(IDI_ENTERPRISE);
	//m_treeEnterprise.SetRootIcon( m_icon );
	//m_icon = AfxGetApp()->LoadIcon(IDI_DEPARTMENT);
	//m_treeEnterprise.SetParentIcon( m_icon );
	// contact
	...
	m_treeContacts.SetRectangle(RGB(144,174,205));
	//m_treeContacts.SetItemIcon( theApp.GetIconCon() );
	m_treeContacts.SetCallback((CTreeCallback*)this);
	...
	m_treeEnterprise.SetRectangle(RGB(144,174,205));
	...
	m_treeEnterprise.SetCallback((CTreeCallback*)this);
	m_treeEnterprise.ShowWindow(SW_HIDE);

	m_treeSelected.SetItemHeight(28);
	m_treeSelected.SetIconSize(26,26);
	//m_treeSelected.SetRectangle(RGB(144,174,205));
	//m_treeSelected.SetRootIcon( theApp.GetIconCon() );
	//m_treeSelected.SetItemIcon( theApp.GetIconCon() );
	//float h,s,l;
	//::RGBtoHSL(GetRValue(theApp.GetMainColor()), GetGValue(theApp.GetMainColor()), GetBValue(theApp.GetMainColor()),&h,&s,&l);
	//COLORREF colorFrom = ::HSLtoRGB(h, s, 0.95);
	//m_treeSelected.SetBkGradients(colorFrom,colorFrom);
	m_treeSelected.SetBkGradients(theApp.GetBgColor1(),theApp.GetBgColor1());
	m_treeSelected.SetBkMode(VividTree::BK_MODE_GRADIENT);
	m_treeSelected.SetCallback((CTreeCallback*)this);

	m_treeSearch.SetItemHeight(28);
	m_treeSearch.SetIconSize(26,26);
	m_treeSearch.SetRectangle(RGB(144,174,205));
	//m_treeSearch.SetRootIcon( theApp.GetIconCon() );
	//m_treeSearch.SetItemIcon( theApp.GetIconCon() );
	m_treeSearch.SetCallback((CTreeCallback*)this);
...
void CDlgSelectUser::Fire_onSearchGroupInfo(IEB_GroupInfo* pGroupInfo, IEB_EnterpriseInfo* pEnterpriseInfo, ULONG dwParam)
{
	...
	if (pEntItemInfo.get()!=NULL)
	{
		...
		m_treeEnterprise.Sort(pParentDepItemInfo->m_hItem,CEBUIApp::TreeCmpFunc);

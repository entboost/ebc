...
void CDlgIncomingCall::DrawInfo(void)
{
	...
	if (m_pCallInfo.m_sGroupCode==0)
		graphics.DrawString(L"新会话请求...",-1,&fontTitle,PointF(13,13),&brushEbTitle);
	else
		graphics.DrawString(L"多人会话请求...",-1,&fontTitle,PointF(13,13),&brushEbTitle);
...
void CDlgIncomingCall::OnSize(UINT nType, int cx, int cy)
{
	...
	int y = cy-const_btn_height-10;		// 最下面间隔

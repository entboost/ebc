...
class ClientHandler : public CefClient,
 ...
 public:
  ...
  ClientHandler(CCefBrowserHandler* pHandler);
  ...
  CLockMap<uint32,CefDownloadInfo::pointer> m_pFileDownloadList;
  bool m_bCloseAll;
  ...
  bool CanExecuteJavaScript(const std::string& sFunctionName) const {return m_pCanExecuteJavaScriptList.exist(sFunctionName);}
  ...
  void SetHandler(CCefBrowserHandler* h) {m_pHandler = h;}
 ...
 private:
  ...
  bool ExecuteTestMenu(int command_id, const wchar_t* lpszUrl);
  ...
  CLockMap<std::string,bool> m_pCanExecuteJavaScriptList;	// for entboost javascript

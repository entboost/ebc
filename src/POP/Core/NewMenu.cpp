...
BOOL CNewMenu::m_bDisableShade = FALSE;
BOOL CNewMenu::m_bDisableSelBorder = FALSE;
...
BOOL CNewMenu::SetDisableShade(BOOL bDisable)
{
  BOOL bOldMode = m_bDisableShade;
  m_bDisableShade = bDisable;
  return bOldMode;
}
BOOL CNewMenu::GetDisableShade(void)
{
	return m_bDisableShade;
}

BOOL CNewMenu::SetDisableSelBorder(BOOL bDisable)
{
  BOOL bOldMode = m_bDisableSelBorder;
  m_bDisableSelBorder = bDisable;
  return bOldMode;
}
BOOL CNewMenu::GetDisableSelBorder(void)
{
	return m_bDisableSelBorder;
}
        ...
        if(state&ODS_CHECKED || info.hbmpUnchecked)
        {
          ...
          if (state&ODS_CHECKED)
          {
            ...
            { // Draw Bitmap
              ...
              pDC->DrawState(Offset,pSize,info.hbmpChecked,DST_BITMAP|DSS_MONO);
            }
          }
          else if(info.hbmpUnchecked)
          {
            ...
            if(state & ODS_DISABLED)
            {
              pDC->DrawState(Offset,pSize,info.hbmpUnchecked,DST_BITMAP|DSS_MONO|DSS_DISABLED);
            }
            else
            {
              pDC->DrawState(Offset,pSize,info.hbmpUnchecked,DST_BITMAP|DSS_MONO);
            }
          }
        }

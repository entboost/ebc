...
public:
  ...
  static BOOL SetDisableShade(BOOL bDisable=TRUE);
  static BOOL GetDisableShade(void);

  static BOOL SetDisableSelBorder(BOOL bDisable=TRUE);
  static BOOL GetDisableSelBorder(void);
...
protected: 
  ...
  static BOOL m_bDisableShade;		// add by hd
  static BOOL m_bDisableSelBorder;	// add by hd
  // Jan-12-2005 - Mark P. Peterson - mpp@rhinosoft.com - http://www.RhinoSoft.com/
  // added gloom factor

...
const int EB_SID_LOGON_TYPE	= EB_LOGON_TYPE_PC|EB_LOGON_TYPE_IOS|EB_LOGON_TYPE_ANDROID|EB_LOGON_TYPE_WP|EB_LOGON_TYPE_WEB|EB_LOGON_TYPE_MAC|EB_LOGON_TYPE_SERVER|EB_LOGON_TYPE_APPID;
const int EB_PHONE_LOGON_TYPE	= EB_LOGON_TYPE_IOS|EB_LOGON_TYPE_ANDROID|EB_LOGON_TYPE_WP;
